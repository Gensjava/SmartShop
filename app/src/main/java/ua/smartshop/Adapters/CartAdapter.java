...
public class CartAdapter extends ArrayAdapter<Cart>  {
    ...
    private onVaultEventListener someEventListener ;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            //
            viewHolder.deleteButton = (ImageView) convertView.findViewById(R.id.cart_delete_button);
            viewHolder.plusButton = (ImageView) convertView.findViewById(R.id.cart_plus_button);
            viewHolder.minusButton = (ImageView) convertView.findViewById(R.id.cart_minus_button);
        ...
        if(item != null){
            ...
            viewHolder.plusButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //
                    someEventListener = (onVaultEventListener) mContext;
                    someEventListener.someVaultEvent(TEG_GART_TOTAL);
                }
            });
    ...
    public interface onVaultEventListener {
        public void someVaultEvent(String view_id);
    }
