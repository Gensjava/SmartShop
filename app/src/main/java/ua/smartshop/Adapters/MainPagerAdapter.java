...
public class MainPagerAdapter extends PagerAdapter {
    ...
    public MainPagerAdapter(Context context, CategoryProduct categoryProduct[]) {
        ...
        this.mScreenTitles = mContext.getResources().getStringArray(R.array.banner_array);
    }
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                someEventListener.someEvent(ACTION_ONCLIK_ITEM_PEGER_ADAPTER, mScreenTitles[position]);
            }
        });
