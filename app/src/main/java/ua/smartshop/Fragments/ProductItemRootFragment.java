...
public class ProductItemRootFragment extends android.support.v4.app.Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,  Bundle savedInstanceState) {
        ...
        try {
            rootView = inflater.inflate(R.layout.product_item_root, container,
                    false);
