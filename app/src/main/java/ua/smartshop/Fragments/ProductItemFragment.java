 ...
 */
public class ProductItemFragment extends android.support.v4.app.Fragment implements AsyncWorkerInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,  Bundle savedInstanceState) {
        ...
        if(!(ProductItemRootFragment.mItem == null)){
            doSomethingAsyncOperaion(Product.getParamsUrl(ProductItemRootFragment.mItem), getString(R.string.url_details_product),  TypeRequest.GET);
        }
